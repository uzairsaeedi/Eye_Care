...
public class Progress extends BaseActivity {
    ...
    private int currentNavItemId = R.id.nav_progress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bottomNav != null) {
            ...
            bottomNav.setOnItemSelectedListener(menuItem -> {
                ...
                if (id == R.id.nav_test) {
                    intent = new Intent(Progress.this, MainActivity.class)
                            .putExtra("startTab", 0);
                } else if (id == R.id.nav_exercise) {
                    intent = new Intent(Progress.this, EyeExercise.class)
                            .putExtra("startTab", 0);
                } else if (id == R.id.nav_games) {
                    intent = new Intent(Progress.this, EyeGames.class)
                            .putExtra("startTab", 0);
