        ...
        if (bottomNav != null) {
            ...
            bottomNav.setOnItemSelectedListener(menuItem -> {
                ...
                if (selectedId == bottomNav.getSelectedItemId()) {
                    if (selectedId == R.id.nav_exercise) {
                        return true;
                    }
                    return true;
                }
                if (selectedId == R.id.nav_test) {
                    startActivity(new Intent(EyeExercise.this, MainActivity.class)
                            .addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT));
                } else if (selectedId == R.id.nav_exercise) {
                    return true;
                } else if (selectedId == R.id.nav_games) {
                    startActivity(new Intent(EyeExercise.this, EyeGames.class)
                            .addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT));
                } else if (selectedId == R.id.nav_progress) {
                    startActivity(new Intent(EyeExercise.this, Progress.class)
