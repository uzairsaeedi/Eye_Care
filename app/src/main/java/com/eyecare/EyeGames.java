...
public class EyeGames extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eye_games);
        ...
        tvSeeAll.setOnClickListener(v -> {
            Intent i = new Intent(EyeGames.this, Progress.class);
            i.putExtra("startTab", 0);
            startActivity(i);
        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_home) {
                    Intent i = new Intent(EyeGames.this, MainActivity.class);
                    startActivity(i);
                }
                    ...
                    Intent intent = new Intent(EyeGames.this, PrivacyPolicyActivity.class);
        ...
        itemList.add(new ListItem("Track Animal", "20 exercises . 20 min", R.mipmap.listitem1_foreground ));
        itemList.add(new ListItem("Color Cube", "20 exercises . 20 min", R.mipmap.listitem2_foreground));
        itemList.add(new ListItem("Color Match", "20 exercises . 20 min", R.mipmap.listitem1_foreground));
        itemList.add(new ListItem("Odd One Out", "20 exercises . 20 min", R.mipmap.listitem2_foreground));
        ...
        if (bottomNav != null) {
            ...
            bottomNav.setOnItemSelectedListener(menuItem -> {
                ...
                if (selectedId == bottomNav.getSelectedItemId()) {
                    if (selectedId == R.id.nav_games) {
                        return true;
                    }
                    return true;
                }
                if (selectedId == R.id.nav_test) {
                    startActivity(new Intent(EyeGames.this, MainActivity.class)
                            .addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT));
                } else if (selectedId == R.id.nav_exercise) {
                    startActivity(new Intent(EyeGames.this, EyeExercise.class)
                            .addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT));
                } else if (selectedId == R.id.nav_games) {
                    return true;
                } else if (selectedId == R.id.nav_progress) {
                    startActivity(new Intent(EyeGames.this, Progress.class)
